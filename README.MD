...
<p align="center">
    <ul>
        <li> <img width="10px" src="https://github.com/RangerCreaky/TheBunchReUpload/blob/master/snapshots/profile%20icon.jpg" alt="Material Bread logo"> Click on this icon to see your profile. </li>
